...
# SCRIPT:   ipscan.py
# --------------------------------------------------------------------------
# ABSTRACT: Poor Man's parallel IP & standard-port scanner (stdlib-only).
#     Brute-force scans a list of CIDR subnets for ICMP-responsive hosts,
